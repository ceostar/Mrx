...
for xd in range(10000):
	a='Dalvik/2.1.0 (Linux; U; Android 11;'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='SM-A025U Build/RP1A.200720.012)'
	e=random.randrange(100, 9999)
	f='AppleWebKit [PB/172] (KHTML, like Gecko) Chrome/108.0.0.0'
...
for brayen in range(10000):
    ...
    u2 = f"Mozilla/5.0 (Linux; Android 9; Mi Note 8 Pro Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/7.4 OperaMini/59.867.87Chrome/537.36"
    u3 = f"Mozilla/5.0 (Linux; Android 10; Redmi 01A Build/01AQKQ1.191014.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/83.0.4103.101 Mobile Safari/537.36"
    u4 = f"Opera/9.80 (Android; Opera Mini/7.6.35766/191.340; U; ar) Presto/2.12.423 Version/12.16"
    u5 = f"Dalvik/2.1.0 (Linux; U; Android 11; SM-A025U Build/RP1A.200720.012) AppleWebKit [PB/172] (KHTML, like Gecko) Chrome/108.0.0.0 Mobile Safari/537.36"
...
def validate2(idf,pwv):
    ...
    'dpr': '2.75',
    'referer': 'https://mbasic.facebook.com/?stype=lo&deoia=1&jlou=AfdYCC-EO82YYf88T12pOkz2oOK5ZESQe11kNiiQbKjsJt2ir6FM4xONRFssvdaCHesTN3sXbAuQ_QD1Fi3Pjyl6eGkicfBKkFU5iSE8BcqKPw&smuh=12881&lh=Ac9iJbixeawEnZ4tYXk&wtsid=rdr_0YAaishxTqqRg7GYn&_rdr',
